...
FastAPI & Uvicorn: High-performance web framework and ASGI server for API routing.
...
HTML5, CSS3, JavaScript (ES6): The frontend stack used for the responsive dashboard and client-side data exporting (CSV/JSON/TXT).
